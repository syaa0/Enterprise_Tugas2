<?php
$a = $koneksi->query("SELECT * FROM jadwal_ujian WHERE Kode_Jadwalujian='$_GET[id]' ")->fetch_assoc();

?>
<div class="section-header">
    <h1>Edit Data Jadwal Ujian</h1>
    ...
    <div class="card card-primary">
        <div class="card-body">
            <form method="POST" action="">
                <input type="hidden" name="Kode_Jadwalujian" value="<?= $_GET['id'] ?>">
                <div class="row">
...
if (isset($_POST['submit'])) {
    ...
    $edit = $koneksi->query("UPDATE jadwal_ujian SET Nama_Jadwalujian='$_POST[Nama_Jadwalujian]',Tanggal_Ujian='$_POST[Tanggal_Ujian]',Ketua='$_POST[Ketua]',Panitia='$_POST[Panitia]',Penguji='$_POST[Penguji]',Isi_Pengumuman='$_POST[Isi_Pengumuman]',Tempat_Pelaksanaan='$_POST[Tempat_Pelaksanaan]' WHERE Kode_Jadwalujian='$_POST[Kode_Jadwalujian]' ");

    if ($edit) {
        echo "<script>alert('Jadwal Ujian Berhasil di ubah');
